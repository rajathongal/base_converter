...
describe("convertFromBaseNToDecimal()", () => {
    describe('When given a number in base that is less than or equal to 10', () => {
    ...
    describe('when given an invalid nummber in base N', () => {
        test('should throw an error indicating tha the number is not a string', () => {
        ...
        test('should throw an error indicating that the baseFrom must be a number', () => {
            expect(() => converter.convertFromBaseNToDecimal("123", ('5' as unknown) as number)).toThrowError('Base needs to be an integer');
        });
    });
});
...
describe("convertFromDecimalToBaseN()", () => {
    ...
    describe('when given invalid parameters', () => {
        test('should throw and error indicating that the base need to be an integer', () => {
            expect(() => converter.convertFromDecimalToBaseN(10, 45.56)).toThrowError('Base needs to be an integer');
        });
        test("should throw an error indicating that the precision need to be an integer", () => {
            expect(() => converter.convertFromDecimalToBaseN(10, 12, 12.56)).toThrowError('Precison needs to be an integer');
        });
...
describe("convert()", () => {
    describe('when given a number in base N and a number in base M', () => {
        test('should conver the number between these bases', () => {
